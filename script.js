      ...
      item
        ...
        .addEventListener("click", function () {
          ...
          if (bootstrap) {
            ...
            itemIndex.classList.toggle("border-sky-500");
...
const getList = function (todoItems) {
  ...
  todoItems.forEach(function (item, index) {
    if (bootstrap) {
      ...
      itemList.insertAdjacentHTML(
        "beforeend",
        `<div class="item flex justify-between my-3 border-b border-b-sky-500 pb-1">
          <div class="flex gap-1 items-center">
            <h6 class="item-index border border-sky-500 rounded px-2">${index}</h6>
            <p class="item-name capitalize">${item}</p>
          </div>
            <div class="item-icons">
              <i class="far fa-check-circle cursor-pointer complete-item mx-2 item-icon text-sky-500"></i>
